...
[![Form with custom CSS applied](../_images/release-notes/Forms_with_custom_CSS_and_HTML.png)](https://docs.n8n.io/_images/release-notes/Forms_with_custom_CSS_and_HTML.png)
