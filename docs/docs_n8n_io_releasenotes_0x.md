...
#### Community nodes repository[#](#community-nodes-repository "Permanent link")
...
#### Cal.com trigger[#](#calcom-trigger "Permanent link")
...
*   [Telegram Trigger:](../../integrations/builtin/trigger-nodes/n8n-nodes-base.telegramtrigger/) Added support for downloading images to channel\_post updates.
